 ...
 * Source Class: Piece <br>
 * @version generated on Tue Oct 09 13:17:05 CEST 2018 by olj
 */

public interface Piece extends Role, RealizableEntity, ChessPiece {
    ...
    /* ***************************************************
     * Property http://oljontologies.org/games/chess#participatesIn
     */
     
    /**
     * Gets all property values for the participatesIn property.<p>
     * 
     * @returns a collection of values for the participatesIn property.
     */
    Collection<? extends Move> getParticipatesIn();

    /**
     * Checks if the class has a participatesIn property value.<p>
     * 
     * @return true if there is a participatesIn property value.
     */
    boolean hasParticipatesIn();

    /**
     * Adds a participatesIn property value.<p>
     * 
     * @param newParticipatesIn the participatesIn property value to be added
     */
    void addParticipatesIn(Move newParticipatesIn);

    /**
     * Removes a participatesIn property value.<p>
     * 
     * @param oldParticipatesIn the participatesIn property value to be removed.
     */
    void removeParticipatesIn(Move oldParticipatesIn);
     ...
     */
    Collection<? extends Taken> getOccupies();
     ...
     */
    void addOccupies(Taken newOccupies);
     ...
     */
    void removeOccupies(Taken oldOccupies);
