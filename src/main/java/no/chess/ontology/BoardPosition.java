...
public interface BoardPosition extends Continuant, ChessPosition {

    /* ***************************************************
     * Property http://oljontologies.org/games/chess#isVacant
     */
     
    /**
     * Gets all property values for the isVacant property.<p>
     * 
     * @returns a collection of values for the isVacant property.
     */
    Collection<? extends Vacant> getIsVacant();

    /**
     * Checks if the class has a isVacant property value.<p>
     * 
     * @return true if there is a isVacant property value.
     */
    boolean hasIsVacant();

    /**
     * Adds a isVacant property value.<p>
     * 
     * @param newIsVacant the isVacant property value to be added
     */
    void addIsVacant(Vacant newIsVacant);

    /**
     * Removes a isVacant property value.<p>
     * 
     * @param oldIsVacant the isVacant property value to be removed.
     */
    void removeIsVacant(Vacant oldIsVacant);
