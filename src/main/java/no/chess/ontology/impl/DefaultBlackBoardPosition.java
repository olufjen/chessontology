 ...
 * Source Class: DefaultBlackBoardPosition <br>
 * @version generated on Tue Oct 09 13:17:05 CEST 2018 by olj
 */
public class DefaultBlackBoardPosition extends WrappedIndividualImpl implements BlackBoardPosition {

    public DefaultBlackBoardPosition(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Move> getAffectedBy() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_AFFECTEDBY,
                                               DefaultMove.class);
    }

    public boolean hasAffectedBy() {
	   return !getAffectedBy().isEmpty();
    }

    public void addAffectedBy(Move newAffectedBy) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_AFFECTEDBY,
                                       newAffectedBy);
    }

    public void removeAffectedBy(Move oldAffectedBy) {
