 ...
 * Source Class: DefaultChessPosition <br>
 * @version generated on Mon Jul 23 13:24:46 CEST 2018 by olj
 */
public class DefaultChessPosition extends WrappedIndividualImpl implements ChessPosition {

    public DefaultChessPosition(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Vacant> getIsVacant() {
        return (Collection<? extends Vacant>) getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISVACANT,
                                               DefaultVacant.class);
    }

    public boolean hasIsVacant() {
	   return !getIsVacant().isEmpty();
    }
    ...
    public Collection<? extends java.lang.Object> getHasName() {
    	//String name = getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASNAME, Object.class);
