 ...
 * Source Class: DefaultBlackPlayer <br>
 * @version generated on Mon Jul 23 13:24:46 CEST 2018 by olj
 */
public class DefaultBlackPlayer extends WrappedIndividualImpl implements BlackPlayer {

    public DefaultBlackPlayer(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends WrappedIndividual> getHasAvailable() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASAVAILABLE,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasHasAvailable() {
	   return !getHasAvailable().isEmpty();
    }

    public void addHasAvailable(WrappedIndividual newHasAvailable) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASAVAILABLE,
                                       newHasAvailable);
    }

    public void removeHasAvailable(WrappedIndividual oldHasAvailable) {
    ...
    public Collection<? extends Move> getMakeMove() {
        return (Collection<? extends Move>) getDelegate().getPropertyValues(getOwlIndividual(),
    ...
    public void addMakeMove(Move newMakeMove) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_MAKEMOVE,
                                       newMakeMove);
    }

    public void removeMakeMove(Move oldMakeMove) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_MAKEMOVE,
                                          oldMakeMove);
    }
    ...
    public Collection<? extends ChessGame> getPlays() {
        return (Collection<? extends ChessGame>) getDelegate().getPropertyValues(getOwlIndividual(),
