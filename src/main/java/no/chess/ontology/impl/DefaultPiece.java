...
public class DefaultPiece extends WrappedIndividualImpl implements Piece {
    ...
    public Collection<? extends no.chess.ontology.Object> getHasName() {
		return (Collection<? extends no.chess.ontology.Object>) getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASNAME, Object.class);
    }
