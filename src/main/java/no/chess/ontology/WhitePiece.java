 ...
 * Source Class: WhitePiece <br>
 * @version generated on Mon Jul 23 13:24:47 CEST 2018 by olj
 */

public interface WhitePiece extends Piece, Occupant {

    /* ***************************************************
     * Property http://oljontologies.org/games/chess#isAvailablefor
     */
     
    /**
     * Gets all property values for the isAvailablefor property.<p>
     * 
     * @returns a collection of values for the isAvailablefor property.
     */
    Collection<? extends Player> getIsAvailablefor();

    /**
     * Checks if the class has a isAvailablefor property value.<p>
     * 
     * @return true if there is a isAvailablefor property value.
     */
    boolean hasIsAvailablefor();

    /**
     * Adds a isAvailablefor property value.<p>
     * 
     * @param newIsAvailablefor the isAvailablefor property value to be added
     */
    void addIsAvailablefor(Player newIsAvailablefor);

    /**
     * Removes a isAvailablefor property value.<p>
     * 
     * @param oldIsAvailablefor the isAvailablefor property value to be removed.
     */
    void removeIsAvailablefor(Player oldIsAvailablefor);
