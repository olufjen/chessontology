 ...
 * Source Class: Taken <br>
 * @version generated on Tue Oct 09 13:17:05 CEST 2018 by olj
 */

public interface Taken extends BoardPosition {

    /* ***************************************************
     * Property http://oljontologies.org/games/chess#affectedBy
     */
     
    /**
     * Gets all property values for the affectedBy property.<p>
     * 
     * @returns a collection of values for the affectedBy property.
     */
    Collection<? extends Move> getAffectedBy();

    /**
     * Checks if the class has a affectedBy property value.<p>
     * 
     * @return true if there is a affectedBy property value.
     */
    boolean hasAffectedBy();

    /**
     * Adds a affectedBy property value.<p>
     * 
     * @param newAffectedBy the affectedBy property value to be added
     */
    void addAffectedBy(Move newAffectedBy);

    /**
     * Removes a affectedBy property value.<p>
     * 
     * @param oldAffectedBy the affectedBy property value to be removed.
     */
    void removeAffectedBy(Move oldAffectedBy);
     ...
     */
    Collection<? extends WrappedIndividual> getIsOccupiedBy();
     ...
     */
    void addIsOccupiedBy(WrappedIndividual newIsOccupiedBy);
     ...
     */
    void removeIsOccupiedBy(WrappedIndividual oldIsOccupiedBy);
